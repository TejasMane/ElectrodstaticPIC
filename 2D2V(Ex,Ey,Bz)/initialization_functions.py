...
def set_up_cosine_perturbation( positions_x, positions_y, number_particles, N_divisions_x,\
                                N_divisions_y, amplitude, k_x, k_y, length_domain_x,\
                                length_domain_y, dx, dy\
                              ):
    '''
...
def set_up_sine_perturbation( positions_x, positions_y, number_particles, N_divisions_x,\
                                N_divisions_y, amplitude, k_x, k_y, length_domain_x,\
                                length_domain_y, dx, dy\
                              ):
    '''
    ...
    for j in range(N_divisions_y):
        for i in range(N_divisions_x):
            ...
            # Amplitude in the current grid cell used to compute number of particles in the
            # current grid cell
            temp_amplitude = amplitude * np.sin((k_x * (i + 0.5) * dx / length_domain_x) + \
                                                (k_y * (j + 0.5) * dy / length_domain_y))
